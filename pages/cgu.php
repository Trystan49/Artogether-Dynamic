...
<div class="main-content">
    <div class="cgu">
        ...
        <strong class="article"><u>Article 1 :</u> &nbsp;Objet</strong>
        <br>
        <p>Les présentes CGU ou Conditions Générales d’Utilisation encadrent juridiquement l’utilisation des services du site ARTOGETHER (ci-après dénommé « le site »).
        Constituant le contrat entre la société ARTOGETHER, l’Utilisateur, l’accès au site doit être précédé de l’acceptation de ces CGU. L’accès à cette plateforme signifie l’acceptation des présentes CGU.</p> 
        <strong class="article"><u>Article 2 :</u> &nbsp;Accès au site</strong>
        <br>
        <p>Le site ARTOGETHER permet d’accéder gratuitement aux services suivants :</p>
        <ul>
            <li>
                Découverte de l'artiste et de ses oeuvres (art, logo, artgraphique)
            </li>
            <li>
                Service de création de logo et de charte graphique.
            </li>
            <li>
                Espace de création de compte pour obtenir la possibilité de commenter les oeuvres de l'artiste.
            </li>
        </ul>
        ...
        L’accès aux services dédiés aux membres s’effectue à l’aide d’un pseudo et d’un mot de passe.
        ...
        <strong class="article"><u>Article 3 :</u> &nbsp;Propriété intellectuelle</strong>
        <br>
        <p>Les marques, logos ainsi que les contenus du site ARTOGETHER (illustrations graphiques, textes…) sont protégés par le Code de la propriété intellectuelle et par le droit d’auteur.
        ...
        <strong class="article"><u>Article 4 :</u> &nbsp;Responsabilité</strong>
        <br>
        ...
        <strong class="article"><u>Article 5 :</u> &nbsp;Liens hypertextes</strong>
        <br>
        ...
        <strong class="article"><u>Article 6 :</u> &nbsp;Publication par l’Utilisateur</strong>
        <br>
        <p>Le site ARTOGETHER permet aux membres de publier des commentaires.
